...
Version  : 2.4
Release  : 3
URL      : http://archive.apache.org/dist/commons/io/source/commons-io-2.4-src.tar.gz
Source0  : http://archive.apache.org/dist/commons/io/source/commons-io-2.4-src.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-commons-io-data
...
%package data
Summary: data components for the jdk-commons-io package.
Group: Data

%description data
data components for the jdk-commons-io package.


%prep
%setup -q -n commons-io-2.4-src

python3 /usr/share/java-utils/mvn_file.py  : commons-io apache-commons-io
...
%install
xmvn-install  -R .xmvn-reactor -n apache-commons-io -d %{buildroot}
